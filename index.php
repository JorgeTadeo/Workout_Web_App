...
<body id="darkmode">
	...
	<nav class="navbar navbar-dark bg-primary navbar-expand nav-primary" id="nav">
	  <a class="navbar-brand no-right-margin" href=""><img id="logo" src="logo2.png" ></a>
	...
	<table class="center-justify">
		...
		<p><strong>1. </strong>Enter your training max</p>
		<tr>
			<td>Squat</td>
	...
	<p class="text-center">Your working weight, set and reps</p>
	...
	<canvas class="layout-border-primary" id="myChart"></canvas>
	</div>
	<div class="col-lg-6 padding">
	<canvas class="layout-border-primary" id="myChart1"></canvas>
	</div>
	</div>
	</div>
	...
	<div class="row">
	<div class="col-lg-6 padding">
	<canvas class="layout-border-primary" id="myChart2"></canvas>
	</div>
	<div class="col-lg-6 padding">
	<canvas class="layout-border-primary" id="myChart3"></canvas>
	</div>
	</div>
	</div>
  ...
  <script>
	...
	var chart = new Chart(ctx, {
		...
		options: {
			...
			title: {
				...
				text: 'Total of lifting weight combined',
				fontSize: 16
			},
			scales: {
				xAxes: [{ 
	...
	var chart = new Chart(ctx, {
		...
		// The data for our dataset
		data: {
			labels: ['Squat', 'Bench', 'Deadlift', 'Overhead-Press'],
			datasets: [{
				label: 'Weight(lbs)',
				backgroundColor: 'rgb(255, 99, 132)',
				borderColor: 'rgb(255, 99, 132)',
		...
		options: {
			  ...
			  title: {
				display: true,
				fontColor: "rgb(255, 255, 255)",
				text: 'Total Weight In Each Lift',
				fontSize: 16
			},	
			 scales: {
				xAxes: [{ 
	...
	var chart = new Chart(ctx, {
		...
		options: {
			  ...
			  title: {
				display: true,
				fontColor: "rgb(255, 255, 255)",
				text: 'Training cycles completed',
				fontSize: 16
			},	
			 scales: {
				xAxes: [{ 
